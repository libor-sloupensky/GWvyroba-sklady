...
<form method="get" action="/production/plans" class="product-filter-form">
  ...
  <label>
    <span>Zna�,�?z�a¤ka</span>
    <select name="znacka_id">
      <option value="">VA"�.A<�??echny</option>
  ...
  <label>
    ...
    <span>Vyhledat</span>
    <input type="text" name="q" value="<?= htmlspecialchars($filterSearch, ENT_QUOTES, 'UTF-8') ?>" placeholder="SKU, nA"�?sA<�??zev, ALT SKU, EAN" />
  </label>
  <div class="search-actions">
    <?php if ($hasSearchActive): ?>
      <div class="search-result-pill">
        Zobrazeno <?= $resultCount ?>
        <a href="/production/plans" class="search-reset" title="ZruA"�.A<�??it filtr">&times;</a>
      </div>
    <?php endif; ?>
...
<?php if (!$hasSearchActive): ?>
  <div class="notice-empty">Zadejte parametry vyhledA"�?sA<�??vA"�?sA<�??nA"�?sA,­ a potvr�,�?z�a�.te tla�,�?z�a¤A"�?sA,­tkem �,�'A?�?s¬�a�lVyhledat�,�'A?�?s¬�a�?s. Seznam produktA"�.�a» a nA"�?sA<�??vrh vA"�?sA<LAroby se zobrazA"�?sA,­ aA"�.A"�l po vyhledA"�?sA<�??nA"�?sA,­.</div>
<?php elseif (empty($items)): ?>
  <div class="notice-empty">Pro zadanA"�?sA,© podmA"�?sA,­nky nejsou dostupnA"�?sA<�?? A"�.A"�lA"�?sA<�??dnA"�?sA<�?? data.</div>
<?php else: ?>
  ...
  <table class="production-table">
    <thead>
      <tr>
        ...
        <th>Rezervace</th>
        <th>C�,­lov�,�t stav</th>
        <th>CA"�?sA,­lovA"�?sA<LA stav</th>
        <th>Dovyrobit</th>
        <th>Priorita</th>
        <th>Min. dA"�?sA<�??vka</th>
        <th>Krok vA"�?sA<LAroby</th>
        <th>VA"�?sA<LArobnA"�?sA,­ doba (dny)</th>
        <th>Akce</th>
      </tr>
    </thead>
    <tbody>
      ...
      <tr class="<?= implode(' ', $rowClasses) ?>" data-sku="<?= htmlspecialchars($sku, ENT_QUOTES, 'UTF-8') ?>">
        <td class="sku-cell" data-sku="<?= htmlspecialchars($sku, ENT_QUOTES, 'UTF-8') ?>">
          <span class="sku-toggle">�,�'A?�,��?sA,¸</span>
        ...
        <td>
          <form method="post" action="/production/produce" class="production-form" data-sku="<?= htmlspecialchars($sku, ENT_QUOTES, 'UTF-8') ?>">
            ...
            <input type="number" step="any" name="mnozstvi" placeholder="mnoA"�.A"�lstvA"�?sA,­" required />
            <button type="submit">Zapsat mnoA"�.A"�lstvA"�?sA,­</button>
          </form>
        </td>
      </tr>
      <?php endforeach; ?>
...
<div class="production-log-controls">
  <form method="post" action="/production/recent-limit">
    <label>PoA"L�et zobrazen�,�tch z�,�?znam�aL�:
  ...
  <table class="production-log-table">
    <thead>
      <tr>
        <th>Datum</th>
        <th>SKU</th>
        <th>N�ZLL�t�ZLL�tzev</th>
        <th>Mno�ZLL�t�ZLL�tstv�ZLL�t�ZLL�t</th>
      </tr>
    </thead>
    <tbody>
...
<?php else: ?>
  <p class="muted">Zat�,­m nejsou zapsan�,© �a�l�,�?dn�,© v�,�troby.</p>
<?php endif; ?>

<div class="production-modal-overlay" id="production-modal">
  <div class="production-modal">
    <h3>Nedostatek komponent</h3>
    <p>Ode�,�?z�a¤et komponent by n�,�?zA?�,�LzkterA"�?sA,© poloA"�.A"�lky poslal do zA"�?sA<�??pornA"�?sA,©ho stavu. Vyberte, jak postupovat:</p>
    <ul id="production-deficit-list"></ul>
    <small>Volba �,�'A?�?s¬�a�lOde�,�?z�a¤A"�?sA,­st subpotomky�,�'A?�?s¬�a�?s automaticky ode�,�?z�a¤te vA"�.A<�??echny komponenty (i do mA"�?sA,­nusu). Volba �,�'A?�?s¬�a�lOde�,�?z�a¤A"�?sA,­st do mA"�?sA,­nusu�,�'A?�?s¬�a�?s zapA"�?sA,­A"�.A<�??e jen hotovA"�?sA<LA produkt a komponenty je potA"�.A?�?z�'eba odepsat ru�,�?z�a¤n�,�?zA?�,�Lz.</small>
    <div class="production-modal-buttons">
      <button type="button" data-action="components">Ode�,�?z�a¤A"�?sA,­st subpotomky (doporu�,�?z�a¤eno)</button>
      <button type="button" data-action="minus">Ode�,�?z�a¤A"�?sA,­st do mA"�?sA,­nusu</button>
      <button type="button" data-action="cancel">ZruA"�.A<�??it</button>
    </div>
  </div>
</div>
...
(function(){
  ...
  forms.forEach((form) => {
    form.addEventListener('submit', (event) => {
      ...
      if (!qty || qty <= 0) {
        alert('Zadejte mnoA"�.A"�lstvA"�?sA,­ vA"�?sA<LAroby.');
        return;
      }
      ...
      checkDeficits(sku, qty)
        ...
        .catch((err) => alert('Nelze ov�,�?zA?�,�LzA"�.A?�?z�'it komponenty: ' + (err.message || err)));
    });
  });
  ...
  function renderDeficits(deficits) {
    ...
    deficits.forEach((item) => {
      ...
      const name = item.nazev ? `${item.sku} �,�'A?�?s¬A?�,�L> ${item.nazev}` : item.sku;
      li.textContent = `${name}: potA"�.A?�?z�'eba ${item.required}, dostupnA"�?sA,© ${item.available}, chybA"�?sA,­ ${item.missing}`;
  ...
  function closeTreeRow() {
    ...
    if (toggle) toggle.textContent = '�,�'A?�,��?sA,¸';
  ...
  async function loadBomTree(sku, container) {
    if (!sku) {
      container.textContent = 'ChybA"�?sA,­ SKU.';
      return;
    }
    try {
      ...
      if (!data.ok) throw new Error(data.error || 'NepodaA"�.A?�?z�'ilo se na�,�?z�a¤A"�?sA,­st strom.');
      container.innerHTML = ';
  ...
  function buildBomTable(tree) {
    if (!tree || !Array.isArray(tree.children) || tree.children.length === 0) {
      ...
      wrap.textContent = 'Produkt nemA"�?sA<�?? navA"�?sA<�??zanA"�?sA,© potomky.';
      return wrap;
    }
    const table = document.createElement('table');
    table.className = 'bom-tree-table';
    table.innerHTML = '<thead><tr><th>Strom vazeb</th><th>Koeficient</th><th>MJ</th><th>Druh vazby</th><th>Typ poloA"�.A"�lky</th><th>DostupnA"�?sA,©</th><th>CA"�?sA,­lovA"�?sA<LA stav</th><th>ChybA"�?sA,­</th></tr></thead>';
    ...
    flattenTree(tree).forEach((row) => {
      ...
      label.textContent = `${row.node.sku} �,�'A?�?s¬A?�,�L> ${row.node.nazev || '}`.trim();
  ...
  function buildPrefix(guides) {
    ...
    guides.forEach((guide, idx) => {
      ...
      if (idx === guides.length - 1) {
        prefix += isLast ? '�,�'A?�,�LAA?�,�LA�,�'A?�,�LAA?�?s¬�,�'A?�,�LAA?�?s¬ ' : '�,�'A?�,�LA�a�?s�,�'A?�,�LAA?�?s¬�,�'A?�,�LAA?�?s¬ ';
      } else {
        prefix += isLast ? '    ' : '�,�'A?�,�LAA?�,�L?   ';
      }
    });
    return prefix;
  }
